            ...
            <div class="col-md-12" id="fh5co-content">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <p><strong>最高学历：</strong><?php echo $info["GrMe_Education"] ?></p>
                                <p><strong>所在高校：</strong><?php echo $info["GrMe_School"] ?></p>
                                <p><strong>是否毕业：</strong><?php echo $info["GrMe_IsGraduated"] ?></p>
                                <p><strong>毕业去向：</strong><?php echo $info["GrMe_Job"] ?></p>
                                ...
                                <p><strong>技能掌握：</strong><?php echo $info["GrMe_Skill"] ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">实践（实习、项目）经历</h3>
                            </div>
                            <ul class="list-group">
                                <?php

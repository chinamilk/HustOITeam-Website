...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_honour VALUES(?, ?, ?, ?)");
    $stmt->bind_param("ssss", $id, $date, $name, $memberId);
...
<head>
    ...
    <title>Add Member Honour Info</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">添加成员荣誉信息</h1>

...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_education VALUES(?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $id, $date, $school, $major, $degree, $memberId);
...
<head>
    ...
    <title>Add Member Education Info</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">添加成员教育信息</h1>

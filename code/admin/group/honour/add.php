...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_grouphonour VALUES(?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $id, $title, $member, $date, $introduction, $photoPath);

    $id = createGuid();
    $title = checkInput($_POST["title"]);
    $member = checkInput($_POST["member"]);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">添加团队荣誉信息</h1>
                <form id="myForm" role="form" id="myForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>标题*</label>
                        <input class="form-control" name="title" id="title" placeholder="25字以内">
                        <p class="help-block"></p>
                    </div>
                    <div class="form-group">
                        <label>获奖成员*</label>
                        <input class="form-control" name="member" id="member">
                        <p class="help-block"></p>
                    </div>
                    <div class="form-group">
                        <label>获奖时间*</label>

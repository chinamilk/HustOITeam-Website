...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_news VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssss", $id, $type, $title, $date, $releaseDate, $publisher, $introduction, $detail, $photoPath);
    ...
    $publisher = checkInput($_POST["publisher"]);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">添加团队新闻、活动、交流信息</h1>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label class="radio-inline">
                                <input type="radio" name="type" id="rTypeCommunication" value="访问交流" checked>访问交流
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="type" id="rTypeNews" value="新闻通知">新闻通知
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="type" id="rTypeActivity" value="团队活动">团队活动
                            </label>
                        </div>
